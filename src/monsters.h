 ...
 */
extern void SpawnMonster(unsigned short int x,unsigned short int y,unsigned short int index);
extern void MonsterAi(void);
extern void ProcFlood(void);
extern void ClearMonsters(void);
void HurtMob(unsigned short int i,unsigned short damage);
extern zzSint32 mobdata[16][16];
