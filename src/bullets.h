 ...
 */
extern void SpawnBullet(signed long int x,signed long int y,unsigned short int angle,unsigned short int type,unsigned short int side);
extern void ProcBullets(void);
extern void ClearBullets(void);
