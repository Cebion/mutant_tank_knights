 ...
 */
#ifndef TPDEF000
typedef signed char	    zzSint8;
typedef signed short	zzSint16;
typedef signed int	    zzSint32;
typedef unsigned char	zzUint8;
typedef unsigned short	zzUint16;
typedef unsigned int	zzUint32;
#define TPDEF000
#endif
